...
namespace zad2
{
    class Program
    {
        ...
        {
            List<string> names = Console.ReadLine().Split(',',(char)StringSplitOptions.RemoveEmptyEntries).ToList();

            string[] comand = Console.ReadLine().Split(',',(char)StringSplitOptions.RemoveEmptyEntries).ToArray();
